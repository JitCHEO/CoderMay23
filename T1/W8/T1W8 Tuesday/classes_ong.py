...
marcus = Student("marcus", 21, "maths") #blueprint
saul = Student("saul", 23, "python") 

# class is a behaviour
# attributes
# constructor
# instance <-> object <-> self in the bracket above
...
class Car:
    ...
    def drives(self):
        print(f"{self.color} is moving forward with {self.passenger} seat")
